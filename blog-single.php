...
// TODO: Query untuk blog post detail dari database (saat ini masih static)
// Untuk sementara, data blog post masih hardcoded di HTML sampai tabel blog_posts terisi
?>
							...
							<div class="widget widget-post">
								...
								<ul class="lab-ul widget-wrapper">
									<li class="d-flex flex-wrap justify-content-between">
										<div class="post-thumb">
											<a href="blog-single.php"><img src="assets/images/product/01.jpg"
													alt="product"></a>
										</div>
